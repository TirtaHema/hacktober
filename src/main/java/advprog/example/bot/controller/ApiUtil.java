...
public class ApiUtil {
    ...
    public static final String uriBase = "https://westcentralus.api.cognitive.microsoft.com/vision"
            + "/v1.0/recognizeText?handwriting=true";

    public static String imageToText(byte[] binaryBytes) {
        HttpClient textClient = HttpClients.createDefault();
        HttpClient resultClient = HttpClients.createDefault();
        ...
        try {
            ...
            for (Header header : responseHeaders) {
                if (header.getName().equals("Operation-Location")) {
                    // This string is the URI where you can get the text recognition
                    // operation result.
