...
public class BillBoardChatHandlerTest {
    ...
    public void testHandleSuccessEvent() {
        ...
        String msg = "/billboard japan100 " + artists.get(0);
    ...
    public void testHandleFailedEvent() {
        String msg = "/billboard japan100 Regensa";
        List<Message> messages = new LinkedList<>();
        List<TextMessage> expectedMessages = new LinkedList<>();
        expectedMessages.add(
            new TextMessage("Sorry, your artist is not valid or doesn't make it to Japan top 100")
        );
    ...
    public void testIgnoreNonTextMessageEvent() {
        assertFalse(billboardChatHandler
