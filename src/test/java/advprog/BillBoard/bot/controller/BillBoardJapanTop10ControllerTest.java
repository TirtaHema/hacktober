...
public class BillBoardJapanTop10ControllerTest {
    static {
    ...
    @Autowired
    private BillBoardJapanTop10Controller billboardJapanTop10Controller;
    ...
    void testHandleDefaultMessage() {
        ...
        billboardJapanTop10Controller.handleDefaultMessage(event);
